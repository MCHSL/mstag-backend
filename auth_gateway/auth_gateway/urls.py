...
urlpatterns = [
	...
	path('api/v1/users/profile/friends/add/<lazyplayer:invitee>/', views.invite_friend),
	path('api/v1/users/profile/friends/remove/<lazyplayer:removee>/', views.remove_friend),
	path('api/v1/users/profile/friends/accept/<lazyplayer:acceptee>/', views.accept_friend),
	path('api/v1/users/profile/friends/decline/<lazyplayer:rejectee>/', views.reject_friend),
